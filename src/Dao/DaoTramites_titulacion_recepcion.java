 ...
 * @author jotruvel
 */
public class DaoTramites_titulacion_recepcion {
    ...
    public int insertarr(Tramites_titulacion_recepcion e){
        int resultado=0;
        clean();
        ...
        try{
            ...
            resultado = st.executeUpdate("INSERT INTO titulacion_recepcion VALUE('"+e.getMatricula()+"','" 
                    +e.getNombre()+"','"
    ...
    public void buscartablar (JTable tabla_recepcion){
        ...
        try{
            Connection con =DBConnection.getConexion();
            Statement st= con.createStatement();
            ResultSet rs= st.executeQuery("SELECT * FROM titulacion_recepcion");
    ...
    public void filtrarMR (JTable tabla, String f) {
        ...
        try {
            Connection con = DBConnection.getConexion();
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("SELECT * FROM titulacion_recepcion WHERE matricula LIKE '%"+f+"%'" );
    ...
    public void filtrarNR (JTable tabla, String f) {
        ...
        try {
            Connection con = DBConnection.getConexion();
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("SELECT * FROM titulacion_recepcion WHERE nombre LIKE '%"+f+"%'" );
