...
import Dao.DaoTramites_certificaciones_entrega;
import Dao.DaoTramites_certificaciones_envio;
import Dto.Tramites_certificaciones_envio;
import javax.swing.JOptionPane;
import javax.swing.table.DefaultTableModel;
import Dto.Tramites_certificaciones_recepcion;
import Dao.DaoTramites_certificaciones_recepcion;
 ...
 * @author jotruvel
 */
public class FrmTramiteCertificaciones extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FrmTramiteCertificaciones
     */
    public FrmTramiteCertificaciones() {
        initComponents();
        ...
        DaoTramites_certificaciones_envio da = new DaoTramites_certificaciones_envio();
        ...
        DaoTramites_certificaciones_recepcion dar = new DaoTramites_certificaciones_recepcion();
        ...
        DaoTramites_certificaciones_entrega dae = new DaoTramites_certificaciones_entrega();
    ...
    private void initComponents() {
        ...
        cbo_tipo1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "PARCIAL", "TOTAL", "DUPLICADO" }));

        cbo_ptipo3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SI", "NO" }));
                        ...
                        .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel7Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(cbo_ptipo3, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                    .addComponent(cbo_tipo1, 0, 163, Short.MAX_VALUE))))
        ...
        cbo_tipo2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "PARCIAL", "TOTAL", "DUPLICADO" }));

        cbo_ptipo2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SI", "NO" }));
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnguardar_recepcion, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        .addContainerGap()
                    ...
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(cbo_tipo2, 0, 164, Short.MAX_VALUE))))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        cbo_tipo3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "PARCIAL", "TOTAL", "DUPLICADO" }));

        jLabel24.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        jLabel24.setText("Pago: ");

        cbo_ptipo1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SI", "NO" }));
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(btnexportar_entraga, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 409, Short.MAX_VALUE)
                                    .addComponent(btnguardar_entrega, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGap(44, 44, 44)
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cbo_ptipo1, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(cbo_tipo3, 0, 158, Short.MAX_VALUE))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        FrmDesbloquearCertificaciones f = new FrmDesbloquearCertificaciones();
        f.show();
        this.hide();
    ...
    private void btnguardar_entregaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardar_entregaActionPerformed
        ...
        Tramites_certificaciones_entrega e = new Tramites_certificaciones_entrega();
        ...
        if (opcion == JOptionPane.YES_NO_OPTION) {
            DaoTramites_certificaciones_entrega da = new DaoTramites_certificaciones_entrega();
    ...
    private void btnguardar_recepcionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardar_recepcionActionPerformed
        ...
        Tramites_certificaciones_recepcion e = new Tramites_certificaciones_recepcion();
        e.setMatricula(txtmatricula.getText());
        e.setNombre(txtnombre.getText());
        ...
        if (opcion == JOptionPane.YES_NO_OPTION) {
            DaoTramites_certificaciones_recepcion da = new DaoTramites_certificaciones_recepcion();
    ...
    private void btnguardar_envioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardar_envioActionPerformed
        ...
        Tramites_certificaciones_envio e = new Tramites_certificaciones_envio();
        e.setMatricula(txtmatricula.getText());
        e.setNombre(txtnombre.getText());
    ...
    private void txtnombre_envioKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtnombre_envioKeyTyped
        ...
        modeloenvio.getDataVector().removeAllElements();
        tabla_envio.updateUI();
        DaoTramites_certificaciones_envio dae = new DaoTramites_certificaciones_envio();
        dae.clean();
        //DaoEscuelasUnitec de= new DaoEscuelasUnitec();
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        FrmReportesCertificaciones f=new FrmReportesCertificaciones();
        f.show();
        this.hide();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmTramiteCertificaciones.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmTramiteCertificaciones().setVisible(true);
            }
        });
    }
