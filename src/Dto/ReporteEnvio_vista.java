 ...
 * @author jotruvel
 */
public class ReporteEnvio_vista {
    ...
    private String curp;
    private String fecha_envio_de;
    private String fecha_envio_hasta;

    public ReporteEnvio_vista() {

    }

    public ReporteEnvio_vista(String matricula, String nombre, String fecha_envio, String observaciones, String tipo_certificado, String pago, String ciclo_egreso, String nombre_escuela, String nombre_carrera, String nombre_escuela_p, String ciclo_ingreso, String curp, String fecha_envio_de, String fecha_envio_hasta) {
        ...
        this.curp = curp;
        this.fecha_envio_de = fecha_envio_de;
        this.fecha_envio_hasta = fecha_envio_hasta;
    }
    ...
    public String getFecha_envio_de() {
        return fecha_envio_de;
    }

    public String getFecha_envio_hasta() {
        return fecha_envio_hasta;
    }
    ...
    public void setFecha_envio_de(String fecha_envio_de) {
        this.fecha_envio_de = fecha_envio_de;
    }

    public void setFecha_envio_hasta(String fecha_envio_hasta) {
        this.fecha_envio_hasta = fecha_envio_hasta;
    }
