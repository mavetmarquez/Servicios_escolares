 ...
 * @author jotruvel
 */
public class ReporteEntrega_vistaTitulacion {
    ...
    private String curp;
    private String fecha_entrega_de;
    private String fecha_entrega_hasta;
    
    public ReporteEntrega_vistaTitulacion(){
        
    }

    public ReporteEntrega_vistaTitulacion(String matricula, String nombre, String fecha_entrega, String observaciones, String tipo_certificado, String pago, String ciclo_egreso, String nombre_escuela, String nombre_carrera, String nombre_escuela_p, String ciclo_ingreso, String curp, String fecha_entrega_de, String fecha_entrega_hasta) {
        ...
        this.curp = curp;
        this.fecha_entrega_de = fecha_entrega_de;
        this.fecha_entrega_hasta = fecha_entrega_hasta;
    }
    ...
    public String getFecha_entrega_de() {
        return fecha_entrega_de;
    }

    public void setFecha_entrega_de(String fecha_entrega_de) {
        this.fecha_entrega_de = fecha_entrega_de;
    }

    public String getFecha_entrega_hasta() {
        return fecha_entrega_hasta;
    }

    public void setFecha_entrega_hasta(String fecha_entrega_hasta) {
        this.fecha_entrega_hasta = fecha_entrega_hasta;
    }
